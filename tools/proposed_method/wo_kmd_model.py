...
# -----------------------------
# Standard modules for ablation
# -----------------------------
# DHTL-Net w/o KMD:
#   DyT             -> nn.LayerNorm
#   MatmulFreeDense -> nn.Linear
#   FourierKAN      -> nn.GELU
#
# Important:
#   All occurrences of MatmulFreeDense in the original model are replaced
#   by standard nn.Linear. No MatMul-free dense layer remains in this file.
#
# All other components remain unchanged:
#   dual-branch ResNet50, frozen source branch, trainable target branch,
#   AlphaGenerator structure, cross-attention, hierarchical adaptive fusion,
#   alpha regularization losses, data loading, profiling, and evaluation.
...
class AlphaGenerator(nn.Module):
    ...
    def __init__(self, in_channels=2048, d_model=256, out_channels=2048, num_heads=4):
        ...
        self.out_proj_alpha = nn.Linear(d_model, out_channels)
